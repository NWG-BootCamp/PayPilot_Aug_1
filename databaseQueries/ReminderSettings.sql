...
DELETE FROM Bills CASCADE CONSTRAINTS; -- Clear existing data if any
DELETE FROM Payments CASCADE CONSTRAINTS; -- insert will not make sense if bills are not there
